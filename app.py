...
@app.route('/lucky/<int:number>')
def lucky_number(number):
    if number < 1 or number > 100:
        return "Число должно быть от 1 до 100! <a href='/'>На главную</a>"

    meanings = {
        7: "Число удачи и мистики",
        13: "Число перемен и сюрпризов",
        21: "Число успеха и достижений",
        33: "Число мастерства и гармонии",
        42: "Ответ на главный вопрос жизни",
        77: "Двойная удача!",
        100: "Идеальное число!"
    }

    meaning = meanings.get(number, "Обычное число.")

    return render_template('lucky.html', number=number, meaning=meaning)
